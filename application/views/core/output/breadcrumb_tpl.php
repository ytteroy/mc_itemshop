<ul class="breadcrumb">
    ...
    <li class="pull-right" style="line-height: 1;">
        <a href="<?php echo site_url('cart/view_contents'); ?>" style="text-decoration: none;">
            <i class="icon-shopping-cart icon-large" style="font-size: 19px;"></i> <span id="cart_stats">[ Mantas kopā: <strong><span id="total-items"><?php echo $this->cart->total_items(); ?></span></strong>; Summa: <strong><span id="total"><?php echo number_format($this->cart->total() / 100, 2, '.', ''); ?></span> EUR</strong> ]</span>
        </a>
    </li>
