        ...
        <div class="form-horizontal well">
            ...
            <fieldset>
                    ...
                    <tbody>
                        ...
                        foreach ($this->cart->contents() as $key => $items): 
                            ...
                            <tr class="item-row" id="<?php echo $key; ?>">
                                ...
                                <td><?php echo number_format(($items['price'] * $items['qty'] / 100), 2, '.', ''); ?> EUR</td>
                            </tr>
                ...
                <div class="stats pull-right">
                    ...
                    <p>Visu mantu summa: <strong><span id="cart-total"><?php echo number_format($this->cart->total() / 100, 2, '.', ''); ?></span> EUR</strong></p>
